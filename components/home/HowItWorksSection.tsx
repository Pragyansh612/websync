...
export default function HowItWorksSection() {
  ...
  return (
    <section className="w-full py-20 md:py-24 lg:py-32 relative overflow-hidden" ref={ref}>
      {/* Enhanced glass effect background elements - simplified for better performance */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none backdrop-blur-xl">
        {/* Main gradient blobs - reduced number for better performance */}
        <m.div
          ...
          {[
            ...
            >
              <div className="mb-6 relative">
                ...
                {/* Animated glow effect - simplified for better performance */}
                <m.div
                ...
                {/* Orbit effect - simplified for better performance */}
                {!prefersReducedMotion && (
                  <>
                    <m.div
