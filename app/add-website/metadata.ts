...
export const metadata: Metadata = {
  title: "Add Website - WebSync | Start Monitoring Your Website",
  description:
  ...
  keywords:
    "add website monitoring, setup website tracking, monitor new website, website performance setup, uptime monitoring configuration, WebSync setup, website health tracking",
  openGraph: {
